...
**Architecture plans and internal improvement backlog**

| Document | Purpose |
|----------|---------|
| **ACA-Migration-Plan.md** | Migration plan from App Service to Azure Container Apps |
| **TODO-AZURE-BOOTSTRAP-IMPROVEMENTS.md** | Prioritized internal backlog for bootstrap, IaC, CI/CD, security, and operations improvements |
...
|----------|---------|----------|--------|
| **1_MASTER_CURRICULUM.md** | Master Azure learning curriculum and day-by-day execution source | Learners, Junior Devs | ✅ Active source of truth |
| **IMPLEMENTATION_NOTES.md** | Detailed execution evidence for completed curriculum days | Learners, Maintainers | ✅ Active support doc |
| **AZURE-PROGRESS-EVALUATION.md** (docs/internal) | Current progress tracker and phase-level next steps | Everyone | ✅ Active |
| **00_MASTER_PLAN.md** | Strategic 18-week microservices migration roadmap | Architects, Senior Devs | ✅ Complete |

**Current Status (April 2026)**:
- ✅ **Days 1-38 complete**: Azure fundamentals, App Service, OIDC, IaC, Azure SQL, DefaultAzureCredential, and resilience baseline
  - **Architecture achieved:** Phases 1-6 complete on the architecture-evolution roadmap
  - **Infrastructure:** SQL Database, Key Vault, Application Insights, and CI/CD with GitHub Actions in place
- 📅 **Next goal:** Day 39 and Phase 7 - tenant enforcement, DDD tactical patterns, and API hardening
- ℹ️ **Weekly planning note:** the legacy weekly learning plan has been archived because the master curriculum and progress evaluation now cover active execution and progress tracking
...
- 📝 **Implementation evidence** → [IMPLEMENTATION_NOTES.md](./05-Self-Learning/Azure-Curriculum/IMPLEMENTATION_NOTES.md)
- 🏗️ **Architecture and migration roadmap** → [ACA-Migration-Plan.md](./04-Enterprise-Architecture/ACA-Migration-Plan.md)

**Latest Updates (April 2026)**:
- ✅ Canonical learning hub activated under `docs/learning/`
- ✅ Curriculum navigation and implementation notes promoted into canonical learning destinations
- ✅ Legacy weekly learning plan retired from the active documentation tree in favor of the master curriculum and progress tracker
