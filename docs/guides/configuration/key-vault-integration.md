...
> **Note**: Key Vault secrets are **automatically populated** during CI/CD deployment. See [keyvault-setup.md](./keyvault-setup.md) for the current operational setup and repair flow.
...
See [keyvault-setup.md](./keyvault-setup.md) for the current automation and recovery workflow.
