...
3. **Review GitHub App configuration**: [github-app-authentication.md](github-app-authentication.md)
---
...
- Detailed guide: [github-app-authentication.md](./github-app-authentication.md)
