...
- **[bootstrap-script-flow.md](./bootstrap-script-flow.md)** - Complete optimized flow documentation for junior developers and code reviewers

For GitHub Actions automation and secret management:
- **[quick-start-azure-bootstrap.md](./quick-start-azure-bootstrap.md)** - Complete end-to-end automation setup (Azure OIDC + GitHub App)
- **[quick-setup-github-app.md](../configuration/quick-setup-github-app.md)** - 5-minute GitHub App setup guide (eliminates PAT expiration)
- **[github-app-authentication.md](../configuration/github-app-authentication.md)** - Technical deep-dive on GitHub App authentication
- **[TROUBLESHOOTING-INDEX.md](../../../TROUBLESHOOTING-INDEX.md)** - GitHub secrets configuration troubleshooting
- **[workflow-automation-visual-guide.md](../configuration/workflow-automation-visual-guide.md)** - Visual workflow automation flow diagrams

For Application Insights monitoring and observability:
- **[app-insights-automated-setup.md](../configuration/app-insights-automated-setup.md)** ⭐ **NEW** - Automated environment-wise App Insights configuration (enterprise approach)
- **[app-insights-automated-setup.md](../configuration/app-insights-automated-setup.md#manual-verification)** - Manual verification reference for App Insights setup
...
- `docs/learning/implementation-notes/implementation-notes-days-29-38.md`
...
**See**: **[app-insights-automated-setup.md](../configuration/app-insights-automated-setup.md)** for complete documentation on the automated approach.
...
**For more KQL examples and troubleshooting**, see [app-insights-automated-setup.md](../configuration/app-insights-automated-setup.md#kql-query-examples)
...
Location: centralindia
Admin User: sqladmin
Admin Password: Auto-generated by bootstrap, stored in Key Vault (`kv-orderprocessing-{env}`)
```
...
- `-AdminPassword`: Retrieved from Key Vault `kv-orderprocessing-{env}` if not supplied (auto-generated by bootstrap)
...
- `-BaseName`: orderprocessing (default)
- `-AdminUsername`: sqladmin (default)
- `-AdminPassword`: Retrieved from Key Vault `kv-orderprocessing-{env}` if not supplied
...
# (Requires SQL client installed; get password from KV first)
$sqlPwd = az keyvault secret show --vault-name kv-orderprocessing-dev --name sql-admin-password --query value -o tsv
sqlcmd -S orderprocessing-sql-dev.database.windows.net -d OrderProcessingSystem_Dev -U sqladmin -P $sqlPwd -Q "SELECT * FROM __EFMigrationsHistory"
```
...
- ✅ SQL admin password: Auto-generated and stored in Key Vault (never hardcoded)
