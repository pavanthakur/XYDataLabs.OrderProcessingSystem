...
**Internal Resources**:
- Review `azure-deployment-guide.md` for detailed setup instructions
- Run `./Resources/Azure-Deployment/check-app-registration.ps1` for OIDC verification
- Check `docs/guides/deployment/` for additional deployment guides
...
- `azure-deployment-guide.md` - Complete deployment strategy
