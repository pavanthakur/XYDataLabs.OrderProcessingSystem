...
| 2026-03-27 | Checklist audit | Log file sink `/logs/webapi-.log` writes to ephemeral Azure App Service filesystem | Low risk — App Insights covers Azure logs when connection string present |
