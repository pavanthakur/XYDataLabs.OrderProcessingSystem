...
builder.AddServiceDefaults("XYDataLabs.OrderProcessingSystem.Notifications.Host");
...
builder.AddPhase10ServiceHostInfrastructure(consumerKind: "Notifications");
...
internal sealed class KeycloakIntrospectionAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    ...
    private static bool ContainsAudience(System.Text.Json.JsonElement audience, string expectedAudience)
    {
        if (audience.ValueKind == System.Text.Json.JsonValueKind.String)
        {
            return string.Equals(audience.GetString(), expectedAudience, StringComparison.Ordinal);
        }

        return audience.ValueKind == System.Text.Json.JsonValueKind.Array
...
internal sealed record KeycloakIntrospectionResponse(
    ...
    bool Active,
    [property: System.Text.Json.Serialization.JsonPropertyName("sub")]
    string? Subject,
    [property: System.Text.Json.Serialization.JsonPropertyName("preferred_username")]
    string? PreferredUsername,
    [property: System.Text.Json.Serialization.JsonPropertyName("email")]
    string? Email,
    [property: System.Text.Json.Serialization.JsonPropertyName("tenant_code")]
    string? TenantCode,
    [property: System.Text.Json.Serialization.JsonPropertyName("aud")]
    System.Text.Json.JsonElement Audience,
    [property: System.Text.Json.Serialization.JsonPropertyName("realm_access")]
    KeycloakRealmAccess? RealmAccess);

internal sealed record KeycloakRealmAccess(
    [property: System.Text.Json.Serialization.JsonPropertyName("roles")]
