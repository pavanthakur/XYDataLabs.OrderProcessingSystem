...
- Deployment target: Azure App Service, Key Vault, managed identity, and OIDC-based CI/CD.
...
Use these expected module candidates unless repository evidence suggests otherwise:
- Orders
- Payments
- Tenants
