    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, configBuilder) =>
        {
            configBuilder.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["ReverseProxy:Routes:orders-api-route:Match:Hosts:0"] = "orders.localhost",
                ...
                ["ReverseProxy:Routes:inventory-route:Match:Hosts:0"] = "inventory.localhost",
                ...
                ["ReverseProxy:Routes:notifications-route:Match:Hosts:0"] = "notifications.localhost",
                ...
                ["ReverseProxy:Routes:ui-route:Match:Hosts:0"] = "ui.localhost",
