...
public sealed class ConfirmPaymentStatusCommandHandler : ICommandHandler<ConfirmPaymentStatusCommand, Result<PaymentStatusDetailsDto>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            _context.TransactionStatusHistories.Add(new TransactionStatusHistory
            {
        ...
        if (payinLog is not null)
        {
            ...
            {
                _context.PayinLogDetails.Add(new PayinLogDetails
                {
    ...
    private static string? ResolveStoredRazorpayOrderId(CardTransaction transaction, PayinLog? payinLog)
    {
    ...
    private static bool HasHistoryEntry(
        IEnumerable<TransactionStatusHistory> historyEntries,
    ...
    private static bool HasPaymentAttemptHistoryEntry(
        IEnumerable<PaymentAttemptHistory> historyEntries,
